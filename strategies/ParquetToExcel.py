...
def parquet_to_excel(date_str, instruments, base_dir='metrics_rollup/hourly', output_file='output.xlsx'):
    """
...
if __name__ == "__main__":
    # ---- User Configuration ----
    date_str = "2025-11-07"  # manually change as needed
    instruments = [2170625,	951809,	5728513,	2977281,	424961,	5633,	175361,	1215745,	315393,	119553,	387073,	3520257,	4574465,	4632577,	1629185,	4454401,	6412545,	3930881,	3529217]  # list of tokens to include
    output_file = f"metrics_rollup/output/metrics_summary_{date_str}.xlsx"
